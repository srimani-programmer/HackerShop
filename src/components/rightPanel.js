                ...
                <Table>
                    ...
                    <TableBody id='shoppingCart'>
                        ...
                        <TableRow id='subTotalRow'>
                            ...
                            <TableCell></TableCell>
                            <TableCell align='center'>$ {Number(props.subTotal).toFixed(2)}</TableCell>
                        </TableRow>
                        <TableRow id='shippingRow'>
                            <TableCell>Shipping</TableCell>
                            <TableCell></TableCell>
                            <TableCell align='center'>$ {Number(props.subTotal) > 50 || Number(props.subTotal) === 0 ? 0 : 3.00}</TableCell>
                        </TableRow>
                        <TableRow id='taxRow'>
                            <TableCell>Tax(5%)</TableCell>
                            <TableCell></TableCell>
                            <TableCell align='center'>$ {(Number(props.subTotal) * 0.05)}</TableCell>
                        </TableRow>
                        <TableRow id="totalPriceRow">
                            <TableCell>Total Price</TableCell>
                            <TableCell></TableCell>
                            <TableCell align='center'>
                                $ {Number(props.subTotal) > 50 || Number(props.subTotal) === 0 ? Number(Number(props.subTotal) + (Number(props.subTotal) * 0.05)).toFixed(2) :
                                    Number(Number(props.subTotal) + (Number(props.subTotal) * 0.05) + 3.00).toFixed(2)}
                            </TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
